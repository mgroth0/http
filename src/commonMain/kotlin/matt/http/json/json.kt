...
suspend inline fun <reified T: Any> HTTPConnectResult.requireIs() = requireSuccessful().text().parse<T>()

suspend inline fun <reified T: Any> HTTPConnectResult.requireIsPartially() = requireSuccessful().text().parse<T>(IgnoreUnknownKeysJson)